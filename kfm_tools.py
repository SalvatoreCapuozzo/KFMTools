...
from samples_scanner import samples_scanner
...
b2 = tk.Button(root, text = "Open Samples Scanner", command = lambda: samples_scanner())
b3 = tk.Button(root, text = "Open Results Analyzer", command = lambda: results_analyzer())
l = tk.Label(root, text="Built by Salvatore Capuozzo, DIETI, University of Naples Federico II - Version 0.1.0")
